...
import {DeleteBtnOrders, EditBtnOrders,CreateBtn} from "../Pages/PageStyled";
import { Select } from 'antd';
import 'antd/dist/antd.css';
import {NavLink} from "react-router-dom";
import TablePagination from '@mui/material/TablePagination';
import EditModal from "./PopupEdit";
            ...
            <div className={'rows'}>
                ...
                <div className={'orders-tablo  m-auto'}>
                    <div className={'d-flex align-items-center'}>
                        <h4 className={'my-4 h4'}>Product</h4>
                        <div className={'mx-2 mt-2'}> {product.length} Products found</div>
                    </div>
                ...
                <OrdersTable>
                    <div className={'category'}>
                        ...
                        <NavLink to={'/create'}>
                            <CreateBtn>Add Product</CreateBtn>
                        </NavLink>
                    ...
                    <div className={'table-row'}>
                        ...
                        {
                            product.length === 0 ? <div className="content-block">
                                <ContentLoader
                                            ...
                                            .map((item,index)=>
                                                <tr key={index}>
                                                    ...
                                                    <td className={'td'}>
                                                     ...
                                                     {new Intl.NumberFormat('USD', { style: 'currency', currency: 'USD' }).format(item.price)}</td>
                                                    ...
                                                    <td className={'td'}>
                                                        ...
                                                        <div className={'d-flex'}>
                                                            ...
                                                            <EditBtnOrders>
                                                                ...
                                                                <EditModal  edits={item}/>

                                                            </EditBtnOrders>

                                                            <DeleteBtnOrders>

                                                                <DeleteModal deletes={item} />
